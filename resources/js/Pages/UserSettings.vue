    ...
    <div class="max-w-3xl mx-auto p-6 bg-gray-50 min-h-screen">
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mb-4">
                ...
                <input v-model="form.zone_big_brother_weight" type="number" class="form-input mt-1 block w-full" />
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input v-model="form.technical_exp_chp_weight" type="number" class="form-input mt-1 block w-full" />
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700">Technical Direction Impulsive Weight</label>
                <input v-model="form.technical_direction_impulsive_weight" type="number"
                    class="form-input mt-1 block w-full" />
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700">Technical Direction Correction Weight</label>
            ...
            <div class="mb-4">
                ...
                <input v-model="form.fundamental_valuation_weight" type="number" class="form-input mt-1 block w-full" />
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700">Fundamental Seasonal Weight</label>
                <input v-model="form.fundamental_seasonal_weight" type="number" class="form-input mt-1 block w-full" />
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700">Fundamental COT Index Weight</label>
                <input v-model="form.fundamental_cot_index_weight" type="number" class="form-input mt-1 block w-full" />
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700">Fundamental Noncommercial Divergence Weight
                </label>
