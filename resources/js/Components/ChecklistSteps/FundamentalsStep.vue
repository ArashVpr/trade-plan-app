    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 gap-6">
            <div class="field">
                ...
                <Dropdown :model-value="modelValue.valuation" @update:model-value="updateData('valuation', $event)"
            ...
            <div class="field">
                ...
                <Dropdown :model-value="modelValue.seasonalConfluence"
            ...
            <div class="field">
                ...
                <Dropdown :model-value="modelValue.nonCommercials"
            ...
            <div class="field">
                ...
                <Dropdown :model-value="modelValue.cotIndex" @update:model-value="updateData('cotIndex', $event)"
